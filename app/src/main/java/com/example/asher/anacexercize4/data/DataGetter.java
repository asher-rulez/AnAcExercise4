...
public class DataGetter {
    public static ArrayList<MovieItemDTO> GetData(Context context){
        ...
        list.add(new MovieItemDTO(R.drawable.infinity_war_poster_small, R.drawable.infinity_war_poster_big,
                ...
                context.getString(R.string.infinity_rd), context.getString(R.string.infinity_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.black_panther_small, R.drawable.black_panther_big,
                ...
                context.getString(R.string.black_panter_rd), context.getString(R.string.black_panter_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.deadpool_two_small, R.drawable.deadpool_big,
                ...
                context.getString(R.string.deadpool_rd), context.getString(R.string.deadpool_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.first_purge_small, R.drawable.purge_big,
                ...
                context.getString(R.string.purge_rd), context.getString(R.string.purge_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.guardians_galaxy_small, R.drawable.guardians_big,
                ...
                context.getString(R.string.guardians_rd), context.getString(R.string.guardians_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.insterstellar_small, R.drawable.interstellar_big,
                ...
                context.getString(R.string.interstellar_rd), context.getString(R.string.interstellar_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.jurasic_world_small, R.drawable.jurassic_big,
                ...
                context.getString(R.string.jurassic_rd), context.getString(R.string.jurassic_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.meg_small, R.drawable.meg_big,
                ...
                context.getString(R.string.meg_rd), context.getString(R.string.meg_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.oceans_eight_small, R.drawable.oceans_big,
                ...
                context.getString(R.string.oceans_rd), context.getString(R.string.oceans_trailer), context.getString(R.string.infinity_poster_url)));
        list.add(new MovieItemDTO(R.drawable.thor_ragnarok_small, R.drawable.thor_big,
                ...
                context.getString(R.string.thor_rd), context.getString(R.string.thor_trailer), context.getString(R.string.infinity_poster_url)));
